...
The first element should be the addition of the first element of each ar
ument
...
Write a function that returns a tuple with the length of a string and it
first character.
...
Return a new list with True or False, depending on whether the integer a
...
If idx is negative or out of range, nothing change (returns the same lis
)
